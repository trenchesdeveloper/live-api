...
const deserializeUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { decoded, expired } = yield (0, jwt_utils_1.verifyJwt)(accessToken, "accessTokenPublicKey");
    if (decoded) {
    ...
    if (expired && refreshToken) {
        ...
        if (typeof newAccessToken === "string") {
            ...
            const result = yield (0, jwt_utils_1.verifyJwt)(newAccessToken, "accessTokenPublicKey");
